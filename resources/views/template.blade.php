<div>
    <div class="bg-base-100 drawer lg:drawer-open"><input id="drawer" type="checkbox" class="drawer-toggle">
                ...
                <nav class="navbar w-full">
                    <div class="flex flex-1 md:gap-1 lg:gap-2"><span
                        ...
                        <div class="flex items-center gap-2 lg:hidden"><a data-sveltekit-preload-data href="/"
                                aria-current="page" aria-label="daisyUI"
                                class="flex-0 btn btn-ghost gap-1 px-2 md:gap-2"><svg class="h-6 w-6 md:h-8 md:w-8"
                                    width="32" height="32" viewBox="0 0 415 415"
                                ...
                                </svg> <span class="font-title text-base-content text-lg md:text-2xl">daisyUI</span></a>
                        </div>
                        <div class="hidden w-full max-w-sm lg:flex"></div>
                    </div>
                    <div class="flex-0">
                        <div class="hidden flex-none items-center lg:block"><a data-sveltekit-preload-data
                                href="/components/" class="btn btn-ghost drawer-button font-normal">Components</a></div>
                        <div class="hidden flex-none items-center lg:block"><a data-sveltekit-preload-data
                                href="/store/" class="btn btn-ghost drawer-button font-normal">Store</a></div>
                        <div class="btn btn-ghost cursor-wait"><svg width="20" height="20"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                class="h-5 w-5 stroke-current md:hidden">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01">
                                </path>
                            </svg> <span class="hidden font-normal md:inline">Theme</span> <svg width="12px"
                                height="12px" class="hidden h-2 w-2 fill-current opacity-60 sm:inline-block"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">
                                <path d="M1799 349l242 241-1017 1017L7 590l242-241 775 775 775-775z"></path>
                            </svg></div>
                        <div class="btn btn-ghost cursor-wait"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 16 16" fill="currentColor" class="h-4 w-4">
            ...
            <div class="max-w-[100vw] px-6 pb-16 xl:pr-2">
                <div class="flex flex-col-reverse justify-between gap-6 xl:flex-row">
                    <div class="prose prose-sm md:prose-base w-full max-w-4xl flex-grow pt-10">
                        <h1>Add component classes to your HTML</h1>
                        <p>How to use daisyUI classes to style your page?</p> Once you <a
                            href="/docs/install/">installed daisyUI</a>, you can use component classes like
                        <code>btn</code>, <code>card</code>, etc. <ol>
                            <li>So instead of making a button using only utility classes:</li>
                        </ol>
    ...
    Button
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code></pre> <button
                            class="inline-block px-4 py-3 text-sm font-semibold text-center text-white uppercase transition duration-200 ease-in-out bg-gray-800 rounded-md cursor-pointer hover:bg-gray-900">Button</button>
                        <ol start="2">
                            <li>You can just use a component class like this:</li>
                        </ol>
                        <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>btn<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Button<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code></pre> <button class="btn">Button</button>
                        <ol start="3">
                            <li>Then you can modify the component with daisyUI additional utility classes:</li>
                        </ol>
                        <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>btn btn-primary<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Button<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code></pre> <button class="btn btn-primary">Button</button>
                        <ol start="4">
                            <li>Or you can modify the component with Tailwind CSS utility classes:</li>
                        </ol>
                        <pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>btn w-64 rounded-full<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Button<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>button</span><span class="token punctuation">></span></span></code></pre> <button class="w-64 rounded-full btn">Button</button>
                        <div class="not-prose pb-10">
                            <div class="bg-base-content/10 mx-1 my-10 h-px"></div>
                            <div class="flex justify-between">
                                <div><a href="/docs/install/" class="btn btn-sm md:btn-md gap-2 lg:gap-3"><svg
                            ...
                            <div class="flex flex-col justify-between gap-2 px-4 text-xs md:flex-row">
                                <div class="flex flex-col gap-2">
                                    <div class="flex items-center gap-2"><svg
                                        ...
                                        <div>Do you have a question? <a target="_blank" rel="noopener, noreferrer"
                                                class="link"
                                    ...
                                    <div class="flex items-center gap-2"><svg
                                        ...
                                        <div>Do you see a bug? <a target="_blank" rel="noopener, noreferrer"
                                                class="link"
                                                href="https://github.com/saadeghi/daisyui/issues?q=Use">open an issue
                                                on GitHub</a></div>
                                    </div>
                                    <div class="flex items-center gap-2"><svg
                                            class="inline-block h-4 w-4 fill-current"
                                        ...
                                        <div>Do you like daisyUI? <a target="_blank" rel="noopener, noreferrer"
                                                class="link"
                                    ...
                                    <div class="flex items-center gap-2"><svg
                                        ...
                                        <div>Support daisyUI's development: <a target="_blank"
                                                rel="noopener, noreferrer" class="link"
                                                href="https://opencollective.com/daisyui">Open Collective</a></div>
                                    </div>
                                </div>
                                <div class="flex flex-col gap-2">
                                    <div class="flex items-center gap-2"><svg
                                        ...
                                        <div><a target="_blank" rel="noopener, noreferrer" class="link"
                                                href="https://github.com/saadeghi/daisyui/blob/master/src/docs/src/routes/(docs)/docs/use/+page.svx?plain=1">Edit
                        ...
                        <div
                            ...
                            <figure class="max-md:bg-primary/10 isolate shrink-0 md:w-2/3"><img
                                    class="pointer-events-none" alt="daisyUI store"
                                    src="https://img.daisyui.com/images/store/nexus.webp"></figure>
                            <div
                            ...
                            <div class="card-body relative isolate z-[3]">
                                ...
                                <div class="grow">
                                    <h2
                                        ...
                                        <svg class="inline h-4 w-4 md:h-6 md:w-6" width="32" height="32"
                                            viewBox="0 0 415 415" xmlns="http://www.w3.org/2000/svg">
                                            <rect x="82.5" y="290" width="250" height="125" rx="62.5"
                                                fill="#1AD1A5"></rect>
                                            <circle cx="207.5" cy="135" r="125" fill="white"></circle>
                                            <circle cx="207.5" cy="135" r="56" fill="#FF9903"></circle>
            ...
            <div class="toast toast-center z-10 [@supports(color:oklch(0%_0_0))]:hidden">
                <div class="alert alert-warning grid-cols-[auto] py-2 text-xs"><span><a class="link"
                            rel="nofollow, noreferrer" target="_blank"
                            href="https://www.wikihow.com/Update-Your-Browser">Please upgrade your browser</a></span>
                </div>
            </div>
        </div>
        <div class="drawer-side z-40" style="scroll-behavior: smooth; scroll-padding-top: 5rem;"><label
                for="drawer" class="drawer-overlay" aria-label="Close menu"></label>
            <aside class="bg-base-100 min-h-screen w-80">
                <div data-sveltekit-preload-data
                    ...
                    <a href="/" aria-current="page" aria-label="Homepage"
                        class="flex-0 btn btn-ghost px-2"><svg width="32" height="32" viewBox="0 0 415 415"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="82.5" y="290" width="250" height="125" rx="62.5" fill="#1AD1A5">
                            </rect>
                ...
                <ul class="menu px-4 py-0">
                    <li>
                        <details id="disclosure-docs" open>
                            ...
                            <ul>
                                ...
                                <li> <a href="/docs/colors/" class="group    "> <span>Colors</span> </a></li>
                                <li> <a href="/docs/themes/" class="group    "> <span>Themes</span> </a></li>
                                <li> <a href="/docs/utilities/" class="group    "> <span>Utilities</span> </a></li>
                                <li> <a href="/docs/layout-and-typography/" class="group    "> <span>Layout &
                    ...
                    <li>
                        <details id="disclosure-components">
                            <summary class="group"><span><svg class="w-5 h-5 text-green-600" width="18"
                                        height="18" viewBox="0 0 48 48" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20 29H6V43H20V29Z" fill="none" stroke="currentColor"
                                            stroke-width="4" stroke-linecap="butt" stroke-linejoin="bevel" />
                                        <path d="M24 4L34 21H14L24 4Z" fill="none" stroke="currentColor"
                                            stroke-width="4" stroke-linecap="butt" stroke-linejoin="bevel" />
                                        <path
                                    ...
                                    </svg></span> Components</summary>
                            <ul>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                viewBox="0 0 48 48" fill="none" stroke="currentColor"
                                                class="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 4V12" stroke-width="4" stroke-linecap="butt"
                                                    stroke-linejoin="bevel" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M22 22L42 26L36 30L42 36L36 42L30 36L26 42L22 22Z"
                                                    fill="none" stroke-width="4" stroke-linecap="butt"
                                                    stroke-linejoin="bevel" />
                                                <path d="M38.1421 9.85789L32.4853 15.5147" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M9.85787 38.1421L15.5147 32.4853" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M4 24H12" stroke-width="4" stroke-linecap="butt"
                                                    stroke-linejoin="bevel" />
                                                <path d="M9.85795 9.85787L15.5148 15.5147" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                            </svg></span> Actions</h2>
                                    <ul>
                                        <li> <a href="/components/button/" class="group    "> <span>Button</span> </a>
                                        </li>
                                        <li> <a href="/components/dropdown/" class="group    "> <span>Dropdown</span>
                                            </a></li>
                                        <li> <a href="/components/modal/" class="group    "> <span>Modal</span> </a>
                                        </li>
                                        <li> <a href="/components/swap/" class="group    "> <span>Swap</span> </a>
                                        </li>
                                        <li> <a href="/components/theme-controller/" class="group    "> <span>Theme
                                                    Controller</span> </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                ...
                                                <circle r="2" transform="matrix(-1.31134e-07 -1 -1 1.31134e-07 16 14)"
                                                    fill="currentColor" />
                                            </svg></span> Data display</h2>
                                    <ul>
                                        <li> <a href="/components/accordion/" class="group    ">
                                                <span>Accordion</span> </a></li>
                                        <li> <a href="/components/avatar/" class="group    "> <span>Avatar</span> </a>
                                        </li>
                                        <li> <a href="/components/badge/" class="group    "> <span>Badge</span> </a>
                                        </li>
                                        <li> <a href="/components/card/" class="group    "> <span>Card</span> </a>
                                        </li>
                                        <li> <a href="/components/carousel/" class="group    "> <span>Carousel</span>
                                            </a></li>
                                        <li> <a href="/components/chat/" class="group    "> <span>Chat bubble</span>
                                            </a></li>
                                        <li> <a href="/components/collapse/" class="group    "> <span>Collapse</span>
                                            </a></li>
                                        <li> <a href="/components/countdown/" class="group    ">
                                                <span>Countdown</span> </a></li>
                                        <li> <a href="/components/diff/" class="group    "> <span>Diff</span> </a>
                                        </li>
                                        <li> <a href="/components/kbd/" class="group    "> <span>Kbd</span> </a></li>
                                        <li> <a href="/components/stat/" class="group    "> <span>Stat</span> </a>
                                        </li>
                                        <li> <a href="/components/table/" class="group    "> <span>Table</span> </a>
                                        </li>
                                        <li> <a href="/components/timeline/" class="group    "> <span>Timeline</span>
                                            </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                viewBox="0 0 48 48" class="h-5 w-5" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="currentColor" stroke-width="4" stroke-linecap="butt"
                                                    stroke-linejoin="bevel" />
                                            </svg></span> Navigation</h2>
                                    <ul>
                                        <li> <a href="/components/breadcrumbs/" class="group    ">
                                                <span>Breadcrumbs</span> </a></li>
                                        <li> <a href="/components/bottom-navigation/" class="group    "> <span>Bottom
                                                    navigation</span> </a></li>
                                        <li> <a href="/components/link/" class="group    "> <span>Link</span> </a>
                                        </li>
                                        <li> <a href="/components/menu/" class="group    "> <span>Menu</span> </a>
                                        </li>
                                        <li> <a href="/components/navbar/" class="group    "> <span>Navbar</span> </a>
                                        </li>
                                        <li> <a href="/components/pagination/" class="group    ">
                                                <span>Pagination</span> </a></li>
                                        <li> <a href="/components/steps/" class="group    "> <span>Steps</span> </a>
                                        </li>
                                        <li> <a href="/components/tab/" class="group    "> <span>Tab</span> </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                class="w-5 h-5" viewBox="0 0 48 48" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4 6H44V36H29L24 41L19 36H4V6Z" fill="none"
                                                    stroke="currentColor" stroke-width="4" stroke-linecap="butt"
                                                    stroke-linejoin="bevel" />
                                                <path d="M23 21H25.0025" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" />
                                                <path d="M33.001 21H34.9999" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" />
                                                <path d="M13.001 21H14.9999" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" />
                                            </svg></span> Feedback</h2>
                                    <ul>
                                        <li> <a href="/components/alert/" class="group    "> <span>Alert</span> </a>
                                        </li>
                                        <li> <a href="/components/loading/" class="group    "> <span>Loading</span>
                                            </a></li>
                                        <li> <a href="/components/progress/" class="group    "> <span>Progress</span>
                                            </a></li>
                                        <li> <a href="/components/radial-progress/" class="group    "> <span>Radial
                                                    progress</span> </a></li>
                                        <li> <a href="/components/skeleton/" class="group    "> <span>Skeleton</span>
                                            </a></li>
                                        <li> <a href="/components/toast/" class="group    "> <span>Toast</span> </a>
                                        </li>
                                        <li> <a href="/components/tooltip/" class="group    "> <span>Tooltip</span>
                                            </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                viewBox="0 0 48 48" class="w-5 h-5" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7 42H43" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M11 26.7199V34H18.3172L39 13.3081L31.6951 6L11 26.7199Z"
                                                    fill="none" stroke="currentColor" stroke-width="4"
                                                    stroke-linejoin="bevel" />
                                            </svg></span> Data input</h2>
                                    <ul>
                                        <li> <a href="/components/checkbox/" class="group    "> <span>Checkbox</span>
                                            </a></li>
                                        <li> <a href="/components/file-input/" class="group    "> <span>File
                                                    Input</span> </a></li>
                                        <li> <a href="/components/radio/" class="group    "> <span>Radio</span> </a>
                                        </li>
                                        <li> <a href="/components/range/" class="group    "> <span>Range</span> </a>
                                        </li>
                                        <li> <a href="/components/rating/" class="group    "> <span>Rating</span> </a>
                                        </li>
                                        <li> <a href="/components/select/" class="group    "> <span>Select</span> </a>
                                        </li>
                                        <li> <a href="/components/input/" class="group    "> <span>Text input</span>
                                            </a></li>
                                        <li> <a href="/components/textarea/" class="group    "> <span>Textarea</span>
                                            </a></li>
                                        <li> <a href="/components/toggle/" class="group    "> <span>Toggle</span> </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                ...
                                                <rect x="6" y="6" width="36" height="36" rx="3"
                                                    fill="none" stroke="currentColor" stroke-width="4"
                                                    stroke-linejoin="bevel" />
                                                <path d="M6 22L42 22" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M29 22V6" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M26 6H32" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M6 19V25" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                                <path d="M42 19V25" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" stroke-linejoin="bevel" />
                                            </svg></span> Layout</h2>
                                    <ul>
                                        <li> <a href="/components/artboard/" class="group    "> <span>Artboard</span>
                                            </a></li>
                                        <li> <a href="/components/divider/" class="group    "> <span>Divider</span>
                                            </a></li>
                                        <li> <a href="/components/drawer/" class="group    "> <span>Drawer</span> </a>
                                        </li>
                                        <li> <a href="/components/footer/" class="group    "> <span>Footer</span> </a>
                                        </li>
                                        <li> <a href="/components/hero/" class="group    "> <span>Hero</span> </a>
                                        </li>
                                        <li> <a href="/components/indicator/" class="group    ">
                                                <span>Indicator</span> </a></li>
                                        <li> <a href="/components/join/" class="group    "> <span>Join (group
                                                    items)</span> </a></li>
                                        <li> <a href="/components/mask/" class="group    "> <span>Mask</span> </a>
                                        </li>
                                        <li> <a href="/components/stack/" class="group    "> <span>Stack</span> </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <h2 class="menu-title flex items-center gap-4 px-1.5"><span
                                            class="text-base-content"><svg width="18" height="18"
                                                ...
                                                <path
                                                    ...
                                                    stroke="currentColor" stroke-width="4" stroke-linejoin="bevel" />
                                                <path d="M22 37H26" stroke="currentColor" stroke-width="4"
                                                    stroke-linecap="butt" />
                                            </svg></span> Mockup</h2>
                                    <ul>
                                        <li> <a href="/components/mockup-browser/" class="group    ">
                                                <span>Browser</span> </a></li>
                                        <li> <a href="/components/mockup-code/" class="group    "> <span>Code</span>
                                            </a></li>
                                        <li> <a href="/components/mockup-phone/" class="group    "> <span>Phone</span>
                                            </a></li>
                                        <li> <a href="/components/mockup-window/" class="group    ">
                    ...
                    <li> <a href="/theme-generator/" class="group    "><span><svg class="h-5 w-5 text-fuchsia-400"
                                    ...
                                    <path d="M29.5856 18.4143L5.54395 42.4559" stroke="currentColor" stroke-width="4"
                                        stroke-linecap="butt" stroke-linejoin="bevel" />
                                </svg></span> <span>Theme Generator</span> </a></li>
                    <li></li>
                    <li> <a href="/store/"
                            class="group    from-primary to-primary/0 hover:to-primary/10 from-[-200%] to-60% [background-image:linear-gradient(-35deg,var(--tw-gradient-stops))]"><span
                                class=" group-hover:text-primary transition-colors"><svg class="h-5 w-5"
                                    width="18" height="18" viewBox="0 0 48 48" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li></li>
                    <li> <a href="/tailwindplay/" target="_blank" rel="noopener noreferrer"
                            class="group    "><span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                    ...
                    <li> <a href="https://github.com/saadeghi/daisyui" target="_blank" rel="noopener noreferrer"
                            class="group    "><span><svg width="18" height="18" class="h-5 w-5"
                                    viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <li> <a href="/discord/" target="_blank" rel="noopener noreferrer" class="group    "><span><svg
                    ...
                    <li> <a href="https://opencollective.com/daisyui" target="_blank" rel="noopener noreferrer"
                            class="group    "><span><svg width="18" class="h-5 w-5" height="18"
                                    viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
    ...
    <script>
        {
            ...
            Promise.all([
                import("../../_app/immutable/entry/start.L_FTo-l3.js"),
                import("../../_app/immutable/entry/app.BU_tdoT_.js")
            ]).then(([kit, app]) => {
