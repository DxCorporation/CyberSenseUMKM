<div class="min-h-[100vh] overflow-hidden pb-40 pt-10 px-8">
    ...
    <ul class="timeline timeline-vertical pt-10 lg:px-20 pb-10">
        <li>
    ...
    <div class="timeline-start text-center timeline-box border border-warning">
        <span
            class="text-[clamp(1.5rem,8vw,1rem)] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 via-green-400 to-cyan-500">Tips Penting</span> <br>
        <ul>
            <li>
